/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1eaaa2f1b885cbde58b5d537a32fa078)
...
interface __BaseEnv_Env {
	...
	GlobalWS: DurableObjectNamespace /* GlobalWS from GlobalWS */;
}
