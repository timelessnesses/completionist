/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 34ba8bdb4bbb07102f11c38344fb7f8e)
...
interface __BaseEnv_Env {
	...
	GlobalWS: DurableObjectNamespace<import("../.svelte-kit/cloudflare/_worker").GlobalWS>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
		durableNamespaces: "GlobalWS";
	}
