/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: dca77cd1106b94e6a299a9591535a8cd)
// Runtime types generated with workerd@1.20260722.1 2026-07-25 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	COMPLETIONIST_KV: KVNamespace;
	COMPLETIONIST_R2: R2Bucket;
	COMPLETIONIST_DB: D1Database;
	COMPLETIONIST_QUEUE: Queue;
	WS_QUEUE: Queue;
	WEBPUSH_QUEUE: Queue;
	EMAIL_QUEUE: Queue;
	GCM_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "AUTHENTICATION_METHOD" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "JWT_SECRET_BASE64" | "PUBLIC_GOOGLE_OAUTH_ANDROID_CLIENT_ID" | "PUBLIC_GOOGLE_OAUTH_CLIENT_ID" | "PUBLIC_ORGANIZATION_DOMAIN" | "REFRESH_TOKEN_SECRET" | "RESEND_API_KEY" | "VAPID_PRIVATE" | "PUBLIC_VAPID_PUBLIC" | "FCM_PROJECT_ID" | "FCM_SERVICE_ACCOUNT" | "CLOUDFLARE_ACCESS_TOKEN" | "CLOUDFLARE_SECRET_ACCESS_TOKEN">> {}
}
